	component soc_system is
		port (
			...
			pio_flag_busy_external_connection_export   : in    std_logic                     := 'X';             -- export
			pio_flag_done_external_connection_export   : in    std_logic                     := 'X';             -- export
			pio_flag_error_external_connection_export  : in    std_logic                     := 'X';             -- export
	...
	u0 : component soc_system
		port map (
			...
			pio_flag_busy_external_connection_export   => CONNECTED_TO_pio_flag_busy_external_connection_export,   --   pio_flag_busy_external_connection.export
			pio_flag_done_external_connection_export   => CONNECTED_TO_pio_flag_done_external_connection_export,   --   pio_flag_done_external_connection.export
			pio_flag_error_external_connection_export  => CONNECTED_TO_pio_flag_error_external_connection_export,  --  pio_flag_error_external_connection.export
